...
module.exports = {
  ...
  apkUrl: 'https://raw.githubusercontent.com/vitalcoder01/kims-parking-frontend/main/releases/KIMS-Parking-v1.7.7.apk',
  notes: 'Updates now download and install right from the app — no more being sent to the browser to fetch them.',
};
